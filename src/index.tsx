...
import { ADMIN_HTML } from './admin-template'
...
// Admin panel page (separate lightweight shell, no storefront renderer)
app.get('/admin', (c) => {
  return c.html(ADMIN_HTML)
})

// Main storefront page (single-page app shell)
app.get('/', (c) => {
  return c.render(
    <>
      ...
      {/* ===== Product Sections (populated by JS) ===== */}
      <main id="app-main">
        ...
        <div class="contact-grid">
          <div class="contact-info">
            ...
            <ul class="contact-list" id="contactList">
              <li id="contactPhone"><i class="fa-solid fa-phone"></i> <span>—</span></li>
              <li id="contactWhatsapp"><i class="fa-brands fa-whatsapp"></i> <span>WhatsApp: —</span></li>
              <li id="contactEmail"><i class="fa-solid fa-envelope"></i> <span>—</span></li>
      ...
      <footer class="site-footer">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <a href="#" id="footerSizeGuide">Size Guide</a>
            <a href="#" id="footerShipping">Shipping Policy</a>
            <a href="#" id="footerReturns">Exchange Policy</a>
          </div>
          <div class="footer-col">
